  ...
  return (
    <div className="relative w-12" style={{ height: `${containerHeight}px` }}>
      ...
      <div
        ...
        className="relative z-10 h-full snap-y snap-mandatory overflow-y-auto scrollbar-hide"
      >
...
const DateTimePickerWebImplementation = (
  ...
  const [tempDateTime, setTempDateTime] = useState<Date>(
      ...
      >
        <PopoverTrigger asChild>
          ...
          >
            ...
            <span
              className={cn(
                "w-full min-w-0 border-none bg-transparent text-xs font-medium outline-none",
                disabled
                  ? "text-neutral-500"
                  : selectedDateTime
                    ? "text-neutral-900"
        ...
        <PopoverContent className="w-auto p-0" align="start">
          ...
          <div className="flex justify-between gap-2 border-t border-neutral-200 p-4">
            <Button

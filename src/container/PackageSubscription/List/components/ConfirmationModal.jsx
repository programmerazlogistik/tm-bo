 ...
 * @param {{ classname: string, variant: string, text: string, onClick: Function }} [props.cancel] - Cancel button configuration. `classname` for additional CSS, `variant` for button style, `text` for button label, `onClick` for click handler.
 * @param {{ classname: string, variant: string, text: string, onClick: Function }} [props.confirm] - Confirm button configuration. `classname` for additional CSS, `variant` for button style, `text` for button label, `onClick` for click handler.
